...
const experience: Experience[] = [
  {
    ...
    date: '2024',
    description: 'Built and deployed 20+ full-stack apps, 1000+ commits and 250+ PRs with >860 hours hands on keys',
    type: 'fullTime',
    ...
    contractWork: [
      {
        ...
        description: 'Built a chat-with-website feature for Bloom AI Tutor, cleanly scrapes the content of any provided URL and loads it into the LLMs context window before initiating a conversation with the user. Built with typescript on next.js with a uvicorn python backend, utilizing jina.ai SDK for scraping and text normalization.'
      },
      {
        company: 'Eyeball',
        location: 'New York',
      ...
      },
      {
        ...
        description: 'Developed end-to-end type safety for an upcoming automation feature, heavily utilizing zod and trpc.'
      }
    ]
  },
  {
      ...
      <div className="max-w-[794px] bg-white print:bg-white border-2 border-black print:border-none mx-auto py-6 print:py-0">
        ...
        >
          <header className="mb-2">
            <h1 className="text-4xl md:text-[44px] print:text-4xl print:mt-0 font-black text-center pb-2">
              Malin Kankanamge
            </h1>
          ...
          <section className="mb-4 text-sm md:text-base print:text-base" id='experience'>
            <h2 className="text-xl font-black mb-2 underline underline-offset-4">
              Experience
            </h2>
          ...
          <section id='education'>
            <h2 className="text-xl font-black mb-2 underline underline-offset-4">Education</h2>
